/* 
 *  Commands for the lovyanGFX library
 *  
 ...
 *  
 *  
 *  Here are important things about the LCD used for the Digital Readout (DRO)
 *  And the Freefonts that can be used.
 *  
 * --------------------------- LCD NOTE ----------------------------------------
  The free font encoding format does not lend itself easily to plotting
  the background without flicker. For values that change on screen it is
...
//  ######################################################################### */
// For screen to work properly with the LilyGO TTGO T-Display V1.1  uncomment these compiler directives in User_Setup.h:
//(Make sure to edit the version used during compilation, if you have multiple User_Setup.h's on your machine)
...
#define TFT_BACKLIGHT   4  // LED back-light
*/

//May not want all of these loaded:
...
#ifdef LOAD_GFXFF // Only include the fonts if LOAD_GFXFF is defined 
